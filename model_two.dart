...
//
//     final postTwo = postTwoFromJson(jsonString);

import 'dart:convert';

PostTwo postTwoFromJson(String str) => PostTwo.fromJson(json.decode(str));

String postTwoToJson(PostTwo data) => json.encode(data.toJson());
...
class PostTwo {
  ...
  factory PostTwo.fromJson(Map<String, dynamic> json) => PostTwo(
        id: json["id"],
